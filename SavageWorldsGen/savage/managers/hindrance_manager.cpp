...
const std::vector<hindrance>& hindrance_manager::get_hindrances() {
  if( s_hindrances == nullptr ) {
    s_hindrances = new std::vector<hindrance> {
      hindrance( "All Thumbs", hindrance_severity_e::minor, "-2 Repair; Roll of 1 casues malfunction" ),
      hindrance( "Anemic", hindrance_severity_e::minor, "-2 to Fatigue tests" ),
      ...
      hindrance( "Bad Luck", hindrance_severity_e::major, "One less Benny per session" ),
      hindrance( "Big Mouth", hindrance_severity_e::minor, "Unable to keep a secret, blabs at the worst time" ),
      hindrance( "Blind", hindrance_severity_e::major, "-6 to all actions that rely on vision; -2 on social rols, gain additional Edge" ),
      ...
      hindrance( "Elderly", hindrance_severity_e::major, "Pace - 1, -1 to Strength and Vigour die types; +5 skill points for any skill linked to Smarts" ),
      ...
      hindrance( "Habit (Major)", hindrance_severity_e::major, "Charisma - 1; Fatigue rolls when deprived" ),
      hindrance( "Habit (Minor)", hindrance_severity_e::minor, "Charisma - 1" ),
      ...
      hindrance( "Lame", hindrance_severity_e::major, "-2 Pace and running die is d4" ),
      hindrance( "Loyal", hindrance_severity_e::minor, "The hero tries to never betray or disappoint their friends" ),
      hindrance( "Mean", hindrance_severity_e::minor, "-2 to Charisma for ill-temper and surliness" ),
      hindrance( "Obese", hindrance_severity_e::minor, "+1 Toughness, -1 Pace, d4 running die" ),
      hindrance( "One Arm", hindrance_severity_e::major, "-2 to tasks requiring two arms" ),
      hindrance( "One Eye", hindrance_severity_e::major, "-1 Charisma, -2 to rolls requiring depth perception" ),
      hindrance( "One Leg", hindrance_severity_e::major, "Pace - 2, d4 running die, -2 to rolls requiring mobility, -2 to swimming rolls" ),
      hindrance( "Outsider", hindrance_severity_e::minor, "-2 Charisma, treated badly by those of dominant society" ),
      ...
      hindrance( "Small", hindrance_severity_e::major, "-1 Toughness" ),
      hindrance( "Stubborn", hindrance_severity_e::minor, "Hero always wants his way" ),
      hindrance( "Ugly", hindrance_severity_e::minor, "-2 Charisma due to appearance" ),
      ...
      hindrance( "Yellow", hindrance_severity_e::major, "The character is cowardly and suffers -2 to Fear checks" ),
      hindrance( "Young", hindrance_severity_e::major, "3 points for Attributes, 10 skill points, +1 Benny per session" )
    };
  }
  return *s_hindrances;
}
